...
class MLDataAccess:
    ...
    def create_model(self, model_name, x_train, x_test, y_train, y_test):
        ...
        model.save(F"/Users/joshpark/Desktop/Projects/FullStack_ML/server/cnn_models/{model_name}.h5")
